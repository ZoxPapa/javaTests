...
public class AdministrativeArea {
    ...
    private AdministrativeArea__1 administrativeArea;
    ...
    @JsonProperty("AdministrativeArea")
    public AdministrativeArea__1 getAdministrativeArea() {
        return administrativeArea;
    }

    @JsonProperty("AdministrativeArea")
    public void setAdministrativeArea(AdministrativeArea__1 administrativeArea) {
